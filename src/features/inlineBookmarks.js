...
class InlineBookmarksCtrl {
    ...
    _addBookmark(document, style, locations) {
        ...
        // if (path.basename(filename) === "sqlite_Export.py") {
        //     this.outputChannel.appendLine("Bookmark might be added for sqlite_Export.py");
        // }

        if (!this.bookmarks.hasOwnProperty(filename)) {
            // if (path.basename(filename) === "sqlite_Export.py") {
            //     this.outputChannel.appendLine("Bookmark being added to root for sqlite_Export.py");
            // }
            this.bookmarks[filename] = {};
        }
        // } else {
        //     if (path.basename(filename) === "sqlite_Export.py") {
        //         this.outputChannel.appendLine("Bookmark already exists for sqlite_Export.py");
        //     }
        // }
...
class InlineBookmarkTreeDataProvider {
    constructor(inlineBookmarksController, outputChannel) {
